...
**Vrutti** is a full-stack AI-powered career guidance platform that helps users discover careers aligned with their **Ikigai** by combining **React (frontend)**, **Flask (backend)**, and **Machine Learning**.
...
✨ *Vrutti bridges passion, skills, and purpose using AI.*
Explore the project, contribute, or collaborate to shape the future of career guidance!
